...
@interface FBHairMenuView ()<UICollectionViewDataSource,UICollectionViewDelegate>

@property (nonatomic, strong) NSArray *listArr;

@end

static NSString *const FBHairMenuViewCellId = @"FBHairMenuViewCellId";

@implementation FBHairMenuView
...
- (UICollectionView *)menuCollectionView{
    if (!_menuCollectionView) {
        ...
        [_menuCollectionView registerClass:[FBHairMenuViewCell class] forCellWithReuseIdentifier:FBHairMenuViewCellId];
    }
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath{
    ...
    FBHairMenuViewCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:FBHairMenuViewCellId forIndexPath:indexPath];
