...
@interface FBGestureMenuView ()<UICollectionViewDataSource,UICollectionViewDelegate>
...
@implementation FBGestureMenuView
...
- (UICollectionView *)collectionView{
    if (!_collectionView) {
        ...
        [_collectionView registerClass:[FBSubMenuViewCell class] forCellWithReuseIdentifier:@"FBGestureMenuViewCell"];
    }
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath{
    ...
    FBSubMenuViewCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:@"FBGestureMenuViewCell" forIndexPath:indexPath];
