...
//@interface FBButtonPositionCacheManager : NSObject
//
//@property (nonatomic, strong) NSCache *cache;
//
//@end
//
//@implementation FBButtonPositionCacheManager
//
//+ (instancetype)sharedInstance {
//    static FBButtonPositionCacheManager * _sharedInstance = nil;
...
// 缓存用数据结构
// */
//@interface FBButtonPositionCacheModel : NSObject
//@property (nonatomic, assign) UIEdgeInsets imageEdgeInsets;
//@property (nonatomic, assign) UIEdgeInsets titleEdgeInsets;
//@property (nonatomic, assign) UIEdgeInsets contentEdgeInsets;
//@end
//
//@implementation FBButtonPositionCacheModel
//@end

@implementation UIButton (FBImagePosition)

//- (void)setImagePosition:(FBImagePosition)postion spacing:(CGFloat)spacing {
//    NSCache *cache = [FBButtonPositionCacheManager sharedInstance].cache;
//    NSString *cacheKey = [NSString stringWithFormat:@"%@_%@_%@", self.currentTitle, @(self.titleLabel.font.hash),@(postion)];
//    FBButtonPositionCacheModel *savedModel = [cache objectForKey:cacheKey];
//    if (savedModel != nil) {
...
//    }
//    
//    FBButtonPositionCacheModel *model = [[FBButtonPositionCacheModel alloc] init];
...
#pragma mark - 新方法 CC
- (void)layoutButtonWithEdgeInsetsStyle:(FBImagePosition)style imageTitleSpace:(CGFloat)space{
