...
#import "FBBodyMenuViewCell.h"
#import "FBUIConfig.h"

@interface FBBodyMenuView ()<UICollectionViewDataSource,UICollectionViewDelegate>

@property (nonatomic, strong) NSArray *listArr;

@end

static NSString *const FBBodyMenuViewCellId = @"FBBodyMenuViewCellId";

@implementation FBBodyMenuView
...
- (UICollectionView *)menuCollectionView{
    if (!_menuCollectionView) {
        ...
        [_menuCollectionView registerClass:[FBBodyMenuViewCell class] forCellWithReuseIdentifier:FBBodyMenuViewCellId];
    }
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath{
    ...
    FBBodyMenuViewCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:FBBodyMenuViewCellId forIndexPath:indexPath];
