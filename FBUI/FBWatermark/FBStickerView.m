...
@interface FBStickerView()<UIGestureRecognizerDelegate>
...
- (instancetype)initWithContentView:(UIView *)contentView {
    ...
    if (self) {
        ...
        self.ctrlType = FBStickerViewCtrlTypeGesture;//默认为手势模式
...
- (void)setCtrlType:(FBStickerViewCtrlType)ctrlType {
    _ctrlType = ctrlType;
    switch (_ctrlType) {
        case FBStickerViewCtrlTypeGesture:
...
- (void)setOriginalPoint:(CGPoint)originalPoint {
    //    if (self.ctrlType == FBStickerViewCtrlTypeGesture) {
...
- (CGFloat)initialAngle {
    if (self.ctrlType == FBStickerViewCtrlTypeOne) {
    ...
    if (self.ctrlType == FBStickerViewCtrlTypeTwo) {
...
- (void)pinch:(UIPinchGestureRecognizer *)gesture {
    ...
    if (self.scaleMode == FBStickerViewScaleModeBounds) {
