...
typedef NS_ENUM(NSInteger, FBImagePosition) {
    FBImagePositionLeft = 0,              //图片在左，文字在右，默认
    FBImagePositionRight = 1,             //图片在右，文字在左
    FBImagePositionTop = 2,               //图片在上，文字在下
    FBImagePositionBottom = 3,            //图片在下，文字在上
};

@interface UIButton (FBImagePosition)
